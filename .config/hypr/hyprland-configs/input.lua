...
hl.bind("switch:on:Lid Switch", hl.dsp.exec_cmd("pidof waylock || waylock -fork-on-lock; systemctl suspend"))
BindMainMod("L", hl.dsp.exec_cmd("pidof waylock || waylock -fork-on-lock"))
